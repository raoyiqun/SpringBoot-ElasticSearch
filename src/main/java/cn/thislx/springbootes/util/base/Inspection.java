...
public class Inspection {
	 ...
	 * @return boolean
	 */
	public static boolean isDOUBLE_NEGATIVE(Double str) {
	...
	public static boolean isEquals(Object obj, String... objs){
		if(null == obj){
			return true;
		}
...
//		System.out.println(Inspection.matcher("/reg/" + ".*", "/reg/f"));
//		Pattern p = Pattern.compile(STR_SPECIAL);
//		Matcher m = p.matcher("dした、ニュースを");
//		System.out.println(m.find());
//		Pattern p = Pattern.compile(STR_SPECIAL2);
//		Matcher m = p.matcher("");
//		System.out.println(m.find());
//		System.out.println(Inspection.matcher("\\p{Punct}", "\f"));
		System.out.println(Inspection.isENG_NUM_("aa+f"));
	}
